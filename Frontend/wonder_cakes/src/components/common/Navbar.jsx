    ...
    <nav className="bg-gray-900 text-white p-4 shadow-md sticky top-0 z-50">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4 md:hidden">
          {/* Cart Icon */}
          <Link to="/cart" aria-label="View Cart" className="hover:text-rose-400 transition-colors duration-200">
      ...
      <div className={`md:hidden ${isMenuOpen ? 'flex' : 'hidden'} flex-col space-y-4 pt-4`}>
        ...
        <Link to="/cart" className="block py-2 px-4 text-sm hover:bg-gray-800 rounded-md transition-colors duration-200" onClick={() => setIsMenuOpen(false)}>Cart</Link>
        {isLoggedIn ? (
